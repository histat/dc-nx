...
<DEFAULT
COMPILE=sh-elf-gcc -ml -m4-single-only -fno-exceptions -I/usr/local/ronin/include -D__SDCARD__ -DNOSERIAL -Os -I../sdlshim -I../sdlshim/SDL -Wreturn-type -Wformat -Wno-multichar -c %SRCFILE% -o %MODULE%.%OBJ_EXT%
