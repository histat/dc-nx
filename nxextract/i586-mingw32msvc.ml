...
<DEFAULT
COMPILE=i586-mingw32msvc-g++ -g -O2 -c %SRCFILE% `i586-mingw32msvc-sdl-config --cflags` -Wreturn-type -Wformat -Wno-multichar -o %MODULE%.%OBJ_EXT%
LPREFIX=i586-mingw32msvc-g++  -o %OUTPUT%
LSUFFIX=`i586-mingw32msvc-sdl-config --libs` -lstdc++ -lm
OBJ_EXT=o
OUTPUT=nxextract
